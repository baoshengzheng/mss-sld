...
<sld:StyledLayerDescriptor
  ...
  <sld:NamedLayer>
    <sld:Name>gis_osm_pofw_a_free_1</sld:Name>
    <sld:UserStyle>
      <sld:Title>Places of Worship (Area) - OSM Carto z17</sld:Title>
      <sld:Abstract>OSM Carto z17 style for Geofabrik gis_osm_pofw_a_free_1</sld:Abstract>
      <sld:IsDefault>1</sld:IsDefault>
      <sld:FeatureTypeStyle>
        <sld:Name>gis_osm_pofw_a_free_1_fts</sld:Name>
        <sld:Title>Places of Worship (Area) - OSM Carto z17</sld:Title>
        <sld:SemanticTypeIdentifier>generic:geometry</sld:SemanticTypeIdentifier>
        <sld:Rule>
          <sld:Name>pofw_area</sld:Name>
          <sld:Title>pofw_area</sld:Title>
          <ogc:Filter>
            <ogc:Or>
